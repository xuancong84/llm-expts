...
class ScriptArguments:
    model_name: str = field(default="unsloth/Llama-3.2-3B-Instruct", metadata={"help": "Model name or path"})
    ...
    per_device_train_batch_size: int = field(default=1, metadata={"help": "Train batch size per device"})
